...
{
	std::cout << "<" << _name << "> default constructor is called!" << std::endl;
}

ClapTrap::ClapTrap(ClapTrap const &claptrap)
{
	std::cout << "<" << _name << "> copy constructor is called!" << std::endl;
	*this = claptrap;
}

ClapTrap::ClapTrap(std::string name) : _name(name), _hp(10), _ep(10), _damage(0)
{
	std::cout << "<" << _name << "> string constructor is called!" << std::endl;
}
...
ClapTrap& ClapTrap::operator=(ClapTrap const &claptrap)
{
	...
	std::cout << "<" << _name << "> assignment operators is called!" << std::endl;
	return (*this);
}
